...
def forecasted_database():    
    ...
    ##############
    forecast_df["Forecasted_active"] = forecasts_active
    forecast_df["Forecasted_active_high"] = forecasts_active_high
    forecast_df["Forecasted_active_low"] = forecasts_active_low
    forecast_df["Forecasted_Active_Cases_Daywise"] = forecasts_active_daywise
    forecast_df["Forecasted_Active_Cases_high_Daywise"] = forecasts_active_daywise_high
    forecast_df["Forecasted_Active_Cases_low_Daywise"] = forecasts_active_daywise_low
    ...
    for region in regions:
        ...
        df2.Active_Cases_Daywise[df2.Region==region] = df2.Active_Cases[df2.Region==region].diff(periods=1)
        df2.Confirmed_Cases_Daywise[df2.Confirmed_Cases_Daywise < 0] = 0
        df2.Active_Cases_Daywise[df2.Active_Cases_Daywise < 0] = 0
